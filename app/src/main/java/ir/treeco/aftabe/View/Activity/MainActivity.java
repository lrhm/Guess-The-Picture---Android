...
//        startService(intent);
    ...
    private void setUpPlayers() {
        ...
        lp.topMargin = (int) ((lengthManager.getHeaderHeight() - playerOne.getRealWidth() * 0.90f) / 2);
        ...
        lpTwo.topMargin = (int) ((lengthManager.getHeaderHeight() - playerOne.getRealWidth() * 0.90f) / 2);
